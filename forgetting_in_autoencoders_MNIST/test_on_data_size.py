...
data_per_class_sizes = [10, 20, 40, 80, 160, 320, 640, 1280, 2560, 5120]
batch_sizes = [100]*len(data_per_class_sizes)
for idx_size, data_per_class in enumerate(data_per_class_sizes): 
  ...
  for try_idx in range(tries_per_size):
    print('Try number {}'.format(try_idx + 1))
    ...
    torch.save(size_accuracies, 'results/size_test_MNIST_{}_images_per_class.pth'.format(data_per_class))

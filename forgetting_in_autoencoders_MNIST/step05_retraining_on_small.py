...
indices = torch.randperm(len(trainset))[:30*1000]
train_loader = DataLoader(trainset, batch_size=opts['batch_size'], sampler = SubsetRandomSampler(indices))
...
for epoch in range(training_epochs):
  ...
  if epoch%10==0:
    ...
    torch.save(accuracies, 'results/retraining_on_small.pth')

...
parser.add_argument('--niter_generation', type=int, default=100, help='number of training epochs')
parser.add_argument('--niter_classification', type=int, default=50, help='number of training epochs')
